...
internal unsafe class PronounHook : HookableElement, IPronounHook
{
    ...
    private delegate uint ProcessNounDelegate(RaptureTextModule* self, nint a2, int a3, nint a4, char a5, int a6, Utf8String* outputString);
    ...
    private uint ProcessNounDetour(RaptureTextModule* self, nint a2, int a3, nint a4, char a5, int a6, Utf8String* outputString)
    {
        uint returner = ProcessNounHook!.Original(self, a2, a3, a4, a5, a6, outputString);
        
        PetServices.PetLog.LogVerbose($"ProcessNounDetour: {a3}, {(int)a5}, {a6}, {outputString->ToString()}");
