...
namespace PetRenamer.Windows
{
    public abstract class TemporaryPetWindow : Window, IDisposable
    {
        ...
        protected TemporaryPetWindow(string name, Action<object> callback, Window blackenedWindow = null!, ImGuiWindowFlags flags = ImGuiWindowFlags.None, bool forceMainWindow = false) : base(name, flags, forceMainWindow)
        {
