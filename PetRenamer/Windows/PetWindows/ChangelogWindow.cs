...
internal class ChangelogWindow : PetWindow
{
    ...
    readonly List<CLS> changeLogs = new List<CLS>()
    {
        ...
        { new CLS(new Version("1.4.4.0"), new CLE("General", "Fixed an issue where the Pet Rename Window would sometimes not work.")) },
        ...
        { new CLS(new Version("1.4.4.3"), new CLE("General", "Fixed log spam that could occur.", "Fixed an issue where upon switching alts another log would spam.")) },
        ...
        { new CLS(new Version("1.4.5.2"), new CLE("General", "It will no longer ask to delete a pet when clicking the + button when searching and adding a pet.")) },
        ...
        { new CLS(new Version("1.4.8.0"), new CLE("General", "Chat messages that Pet Nicknames sets hidden now properly remain hidden.", "Pet Nicknames is now enabled in the Wolves' Den Pier, but as a result even more restricted in non-Wolves' Den Pier zones.")) },
        ...
        { new CLS(new Version("1.5.0.1"), new CLE("General", "Updated to ApiX", "Updated for 7.0 version of the game.")) },
