...
internal class PetHelpWindow : PetWindow
{
    ...
    public override void OnDraw()
    {
        ...
        OverrideLabel("^", Styling.helpButtonSize);
        SameLinePretendSpace();
        OverrideLabel("Use these buttons to toggle between different modes", Styling.FillSize);
    }
    ...
    void DrawNamingHelp()
    {
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace(); 
        Label("Help with naming a pet.", Styling.FillSize);
        NewLine();
        BeginListBox("##Naming Help", new Vector2(782, 648));

        OverrideLabel("1.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("You can open the naming window by right-clicking on your minion or pet and choosing the [Give Nickname] option.", Styling.FillSizeSmall);
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace();
        ...
        NewLine();
        OverrideLabel("2.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("Fill a name into the Text Box and click [Save Nickname].", Styling.FillSizeSmall);
        OverrideLabel("?", Styling.helpButtonSize); SameLinePretendSpace();
        ...
        NewLine();
        OverrideLabel("3.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("If your pet has a nickname and you don't want it to have one anymore? Please click [Remove Nickname].", Styling.FillSizeSmall);
        OverrideLabel("?", Styling.helpButtonSize); SameLinePretendSpace();
        Label("ALL your nicknames will automatically save.", Styling.FillSizeSmall);
        NewLine();

        OverrideLabel("4.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("There is another way to name a Minion or Battle Pet.", Styling.FillSizeSmall);
        OverrideLabel("?", Styling.helpButtonSize); SameLinePretendSpace();
    ...
    void DrawModesHelp()
    {
        ...
        OverrideLabel("1.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("In the top left of some windows small buttons will be located.", Styling.FillSizeSmall);
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace();
        ...
        NewLine();
        OverrideLabel("2.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("There are 3 modes:", Styling.FillSizeSmall);
        ...
        NewLine();
        OverrideLabel("3.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("[Minion Mode]", Styling.FillSizeSmall);
        OverrideLabel("?", Styling.helpButtonSize); SameLinePretendSpace();
        Label("Enable minion mode to give a nickname to minions.", Styling.FillSizeSmall);

        NewLine();
        OverrideLabel("4.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("[Battle Pet Mode]", Styling.FillSizeSmall);
        OverrideLabel("?", Styling.helpButtonSize); SameLinePretendSpace();
        ...
        NewLine();
        OverrideLabel("5.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("[Sharing Mode]", Styling.FillSizeSmall);
        OverrideLabel("?", Styling.helpButtonSize); SameLinePretendSpace();
    ...
    void DrawSharingHelp()
    {
        ...
        OverrideLabel("1.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("Sharing Mode is by far the most interesting mode. You can access the full Sharing Mode window via: ", Styling.FillSizeSmall);
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace();
        Label("[/minionnames] [/petnames] [/minionlist] [/petlist]", Styling.FillSizeSmall);
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace();
        Label("Or the button in the top right corner of most windows.", Styling.FillSizeSmall);
        ...
        OverrideLabel("2.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("Exporting", Styling.FillSizeSmall);
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace();
        ...
        OverrideLabel("3.", Styling.helpButtonSize); SameLinePretendSpace();
        OverrideLabel("Importing", Styling.FillSizeSmall);
        OverrideLabel("!", Styling.helpButtonSize); SameLinePretendSpace();
