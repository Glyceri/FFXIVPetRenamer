...
internal class PetHelpWindow : PetWindow
{
    ...
    public override void OnDrawNormal() => DrawSimpleBar("!", "You are currently in Minion mode!");
    public override void OnDrawBattlePet() => DrawSimpleBar("!", "You are currently in Battle Pet Mode!");
    public override void OnDrawSharing() => DrawSimpleBar("!", "You are currently in Sharing mode!");
    ...
    {
        DrawBarBase(type);
        OverrideLabel(line, Styling.FillSize);
    }

    void DrawSimpleBar(string type, string line)
    {
        DrawBarBase(type);
        Label(line, Styling.FillSize);
    }
