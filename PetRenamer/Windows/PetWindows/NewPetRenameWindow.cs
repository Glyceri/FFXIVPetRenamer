...
[PersistentPetWindow]
[ModeTogglePetWindow]
public class NewPetRenameWindow : InitializablePetWindow
{
    ...
    public NewPetRenameWindow() : base("Pet Nicknames", ImGuiWindowFlags.NoResize | ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse | ImGuiWindowFlags.NoCollapse)
    {
        IsOpen = true;
        Size = baseSize;
    }
