...
internal class BaseTheme : Theme 
{
    ...
    internal override Vector4 panelColour { get; set; } = new Vector4(0.2f, 0.3f, 0.4f, 1f);
    ...
    internal override Vector4 basicLabelColour { get; set; } = new Vector4(0.4f, 0.4f, 0.5f, 1f);
    ...
    internal override Vector4 buttonAlternativeHovered { get; set; } = new Vector4(0.5f, 0.5f, 1f, 1f);
    internal override Vector4 buttonAlternativePressed { get; set; } = new Vector4(0.36f, 0.36f, 1f, 1f);
    internal override Vector4 buttonAlternative { get; set; } = new Vector4(0.3f, 0.3f, 0.8f, 1f);
}
