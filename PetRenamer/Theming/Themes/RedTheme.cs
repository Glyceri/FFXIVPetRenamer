...
internal class RedTheme : BaseTheme
{
    ...
    internal override Vector4 panelColour { get; set; } = new Vector4(0.60f, 0.20f, 0.2f, 1f);
    ...
    internal override Vector4 alternativeText { get; set; } = new Vector4(0.95f, 0.95f, 0.95f, 1f);

    internal override Vector4 basicLabelColour { get; set; } = new Vector4(0.5f, 0.4f, 0.4f, 1f);
    ...
    internal override Vector4 buttonAlternativeHovered { get; set; } = new Vector4(1f, 0.5f,  0.5f, 1f);
    internal override Vector4 buttonAlternativePressed { get; set; } = new Vector4(1f, 0.36f,  0.36f, 1f);
    internal override Vector4 buttonAlternative { get; set; } = new Vector4(0.8f, 0.3f,  0.3f, 1f);
}
